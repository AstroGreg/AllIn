...
export const LanguageProvider = ({ children }) => {
    ...
    useEffect(() => {
        const loadLanguage = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const stored = yield AsyncStorage.getItem(LANGUAGE_STORAGE_KEY);
    ...
    const setLanguage = (code) => __awaiter(void 0, void 0, void 0, function* () {
        setLanguageState(code);
        try {
            yield AsyncStorage.setItem(LANGUAGE_STORAGE_KEY, code);
        }
        catch (_a) {
            // ignore
        }
    ...
    const t = (key) => {
        var _a, _b, _c;
        return (_c = (_b = (_a = translations[language]) === null || _a === void 0 ? void 0 : _a[key]) !== null && _b !== void 0 ? _b : translations.en[key]) !== null && _c !== void 0 ? _c : key;
    };
    ...
    return _jsx(LanguageContext.Provider, Object.assign({ value: value }, { children: children }));
};
