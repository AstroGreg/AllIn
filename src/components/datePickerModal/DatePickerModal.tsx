...
const DatePickerModal = ({ visible, value, onClose, onApply, title, maxDate }: Props) => {
      ...
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.45)', justifyContent: 'center', paddingHorizontal: 20 }}>
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
            <Text style={{ color: colors.mainTextColor, fontSize: 16, fontWeight: '600' }}>
            ...
            >
              <Text style={{ color: colors.mainTextColor, fontSize: 13, fontWeight: '500' }}>
          ...
          <Calendar
            ...
            customHeaderTitle={
              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                ...
                <Text style={{ color: colors.mainTextColor, fontSize: 15, fontWeight: '600', textTransform: 'capitalize' }}>
                  {displayedCalendarMonthLabel}
                </Text>
                <TouchableOpacity
                  style={{
                    width: 28,
            ...
            enableSwipeMonths
            maxDate={maxDate === undefined ? toDateString(new Date()) : maxDate || undefined}
            theme={{
          ...
          >
            <Text style={{ color: colors.pureWhite, fontSize: 13, fontWeight: '600' }}>{t('Done')}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
