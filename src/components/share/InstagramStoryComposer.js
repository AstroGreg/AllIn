...
const InstagramStoryComposer = ({ request, onComplete, onError }) => {
    ...
    useEffect(() => {
        ...
        setBackgroundLoaded(Boolean(!(request === null || request === void 0 ? void 0 : request.imageUri) || (request === null || request === void 0 ? void 0 : request.mode) === 'overlay'));
    }, [request === null || request === void 0 ? void 0 : request.id, request === null || request === void 0 ? void 0 : request.imageUri, request === null || request === void 0 ? void 0 : request.mode]);
