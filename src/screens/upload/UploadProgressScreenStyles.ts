...
export const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    stageText: {...Fonts.medium12, color: colors.primaryColor, marginTop: 8},
    metricsGrid: {
      marginTop: 14,
      flexDirection: 'row',
      flexWrap: 'wrap',
    ...
    metricValue: {...Fonts.medium16, color: colors.mainTextColor},
    metricLabel: {...Fonts.regular12, color: colors.subTextColor, marginTop: 4},
    list: {marginTop: 16},
