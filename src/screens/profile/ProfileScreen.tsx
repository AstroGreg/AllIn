...
const ProfileScreen = ({ navigation }: any) => {
    ...
    return (
        <View style={Styles.mainContainer}>
            ...
            <CustomHeader title='Profile' isBack={false} onPressSetting={() => navigation.navigate('ProfileSettings')} />
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {/* <SizeBox height={10} />
                <View style={[Styles.unfollowCont, Styles.center]}>
                ...
                <SizeBox height={24} />
                <Text style={[Styles.titleText, Styles.container]}>Collections</Text>
                <SizeBox height={16} />
                <View style={[Styles.row, Styles.container]}>
